...
CREATE TABLE "Nortification" (
    ...
    CONSTRAINT "Nortification_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Nortification" ADD CONSTRAINT "Nortification_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
